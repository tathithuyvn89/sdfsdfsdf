<template>
  <div class="app-container">
    <div class="description">
      Laravue provides two directives
      <el-tag class="permission-tag" size="small"> v-role </el-tag> and
      <el-tag class="permission-tag" size="small"> v-permission </el-tag>.
      Please see the belw example here for details
    </div>
    ...
    <div :key="key" style="margin-top: 30px">
      ...
      <div>
        <span v-role="['manager']" class="permission-alert">
          Only
          <el-tag class="permission-tag" size="small">manager</el-tag> can see
          this
        </span>
      ...
      <div>
        <span v-role="['respondent']" class="permission-alert">
          Only
          <el-tag class="permission-tag" size="small">respondent</el-tag> can
          see this
        </span>
        <el-tag
          v-role="['respondent']"
      ...
      <div>
        <span v-role="['visitor']" class="permission-alert">
          Only
          <el-tag class="permission-tag" size="small">visitor</el-tag> can see
          this
        </span>
      ...
      <div>
        <span v-role="['admin', 'respondent']" class="permission-alert">
          Both
      ...
      <div>
        <span v-permission="['manage user']" class="permission-alert">
          ...
          <el-tag class="permission-tag" size="small">manage user</el-tag>
          permission
        </span>
        <el-tag
      ...
      <div>
        ...
        >
          You can see this if you are
          <el-tag class="permission-tag" size="small">admin</el-tag>
          <strong>AND</strong> you have
          <el-tag class="permission-tag" size="small">manage user</el-tag>
          permission
        </span>
        <el-tag
    ...
    <div :key="'checkPermission' + key" style="margin-top: 60px">
      ...
      <el-tabs type="border-card" style="width: 550px">
        ...
        <el-tab-pane v-if="checkRole(['respondent'])" label="Respondent">
          Respondent can see this
          <el-tag class="permission-sourceCode" type="info">
            v-if="checkRole(['respondent'])"
          </el-tag>
        </el-tab-pane>
        ...
        <el-tab-pane
          v-if="checkRole(['admin', 'respondent'])"
          label="Admin-OR-Respondent"
        >
          Both admin or respondent can see this
          <el-tag class="permission-sourceCode" type="info">
            v-if="checkRole(['admin','respondent'])"
          </el-tag>
        </el-tab-pane>
